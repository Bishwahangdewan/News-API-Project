...
myhttp.get("https://newsapi.org/v2/everything?q=anime&language=en&apiKey=4322279a06aa468eafd5e22e265cc2fd",function(response){
    const data = (JSON.parse(response));

    const articles = data.articles;

    articles.forEach(function(article){
        document.querySelector(".anime-content").innerHTML +=
